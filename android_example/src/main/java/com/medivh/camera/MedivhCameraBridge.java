...
/** JNI adapter. All capture/control calls are blocking and belong on a worker thread. */
public final class MedivhCameraBridge {
    ...
    public static native String nativeStart(long handle, int width, int height, int fpsNumerator, int fpsDenominator, boolean nativeOutput);
